            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="<?php echo e(url('/test')); ?>"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
                        <li><a href="<?php echo e(url('/test')); ?>"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
